...
int	ft_count_strings(char *s, char c)
{
	int	count;
	int	i;
...
int	ft_found_sub(char *s, char c, int *i)
{
	int	start;
	int	size;
...
char	*ft_creat_sub(char *s, int start, int size)
{
	char	*new_sub;
	int		j;
...
char	**split_loop(char *s, char c, char **new)
{
	int		i;
	int		size_sub_string;
	int		index;
...
// int main (void)
// {
// 	char s1[] = "  EKip   MMS LDO   NRM 667      petasse ";
// 	char sep = ' ';
